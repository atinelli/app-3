<div>
    @if (can('add_users'))
        ...
        <x-slot name="content">
            ...
            <x-form.input tabindex="1" wire:model="name" label="{{ __('Name') }}" name="name" required></x-form.input>
            <x-form.input tabindex="3" wire:model="email" label="{{ __('Email') }}" name="email" required></x-form.input>
